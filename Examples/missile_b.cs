         ...
         * 
         */
        string RCName = "УДР П-9"; // Name of RC of missile
        string MergeName = "Стыковочный блок П-9"; // Name of merge of missile
        string MassName = "Масса П-9"; // Name of artifical mass of missile
        string AcbName = "Аккумулятор П-9"; // Name of missile batteries
        string WarheadName = "БЧ П-9"; // Name of missile warheads
        string OrientName = "Ориентир для ракет"; // Name of orient name for ATGM mode
        string LCDName = "ИНФО ПКР"; // Name of LCD
        string ConnName = "Коннектор ракеты"; // Name of connector of missile
        string ThrustName = "Ускоритель П-9"; // Name of thruster
        ...
        string GyroName = "Гироскоп П-9"; // Name of Gyro
        //
        double SDist = 20; // Дистанция поиска блоков || Distance of search blocks
        double WDist = 15; // Дистанция подрыва БЧ || Distance of explostion
        ...
        // ENG
        string Estr1 = "Computer of ASM-9 missile system ";
